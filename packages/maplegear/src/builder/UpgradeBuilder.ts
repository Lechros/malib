...
export class UpgradeBuilder {
  ...
  get upgradeLeft(): number {
    ...
    return this.gear.totalUpgradeCount + this.gear.hammerCount - this.gear.upgradeCount - this.gear.failCount;
  }
  ...
  applyScroll(scroll: Scroll): boolean {
    ...
    //   if(this.gear.yggdrasil > 0) {
    //     return false;
    //   }
    //   this.gear.yggdrasil = scroll.yggdrasil;
    // }
