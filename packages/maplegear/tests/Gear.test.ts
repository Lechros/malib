...
//   const gear = new Gear();
//   gear.name = "serialize test gear";
//   gear.props.set(GearPropType.incSTR, 3);
//   gear.icon = 3;
//   gear.origin = [4, 5];
//   const potentialMap = new Map<GearPropType, number>();
//   potentialMap.set(GearPropType.incDEX, 7);
//   gear.potentials.push(new Potential(12345, 15, 150, "test potential", potentialMap));
//   const serialized = serialize(gear);
//   const deserialized = deserialize(Gear, serialized);
//   expect(deserialized.name).toBe("serialize test gear");
//   expect(deserialized.props.get(GearPropType.incSTR)).toBe(3);
//   expect(deserialized.icon.origin).toEqual([4, 5]);
//   expect(deserialized.options[0].code).toBe(12345);
//   expect(deserialized.options[0].props.get(GearPropType.incDEX)).toBe(7);
// });
